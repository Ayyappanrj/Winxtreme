                    ...
                    <div class="game-details-right">
                        <form id="game" novalidate="novalidate">
                                ...
                                <div class="row mtfont">
                                    ...
                                    <div class="col-6">
                                        <h3 class="mb-4 text-center">Game Amount   <span class="base--color">Rs. <span class="game_amount">0 <?php echo 'hai'.$this->session->userdata('user_id');?></span></span></h3>
                                    </div>
                                </div> 
                            ...
                            <div class="form-group justify-content-center d-flex flex-wrap justify-content-between">
                                <div class="row">
                                    <div class="col-4 single-select game-side head gmimg active" data-active="rock" data-value="1">
                                    ...
                                    <div class="col-4 single-select game-side tail gmimg" data-active="paper" data-value="2">
                                    ...
                                    <div class="col-4 single-select game-side tail gmimg" data-active="scissor" data-value="3">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 col-12 text-center"> <span class="mt-3 btn btn-link btn--sm radius-5" id="betButton"> Bet </span> </div>
                            </div>
